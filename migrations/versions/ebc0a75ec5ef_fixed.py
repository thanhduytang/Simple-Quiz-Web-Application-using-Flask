...
Revision ID: ebc0a75ec5ef
Revises: c42d354add2d
Create Date: 2020-05-21 13:04:47.156988
...
revision = 'ebc0a75ec5ef'
down_revision = 'c42d354add2d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('option4', sa.String(length=256), nullable=True),
    ...
    op.create_index(op.f('ix_QA_option4'), 'QA', ['option4'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_QA_option4'), table_name='QA')
